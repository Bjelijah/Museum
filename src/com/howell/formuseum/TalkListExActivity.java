...
import com.howell.formuseum.TalkListActivity.TalkDialogListAdapter.ViewHolder;
...
//		}
	...
	protected void onStop() {
		...
		while(it.hasNext()){
			Map.Entry<Integer, Boolean> entry = (Entry<Integer, Boolean>) it.next();
	...
	public void onDialogListReady() {
		...
		List<ChildEntry> child1 = new ArrayList<TalkListExActivity.ChildEntry>();
		List<ChildEntry> child2 = new ArrayList<TalkListExActivity.ChildEntry>();
